...
# and are needed for the Streamlit app's dropdown menus.
...
numerical_cols_present = [
    ...
    'Hospital_Near_me', 'Mall_Near_me', 'Market_Near_me',
...
if loaded_rf_model and loaded_scaler and loaded_features:
    with st.form("prediction_form"):
        ...
        if submitted:
            ...
            # Add amenities to the dictionary
            ...
            df_processed[numerical_cols_present] = loaded_scaler.transform(df_processed[numerical_cols_present])
